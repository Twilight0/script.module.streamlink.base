...
class StreamlinkLogger(logging.getLoggerClass()):
    ...
    def set_output(output):
        ...
        """
        warnings.warn("Logger.set_output has been deprecated, use the standard logging module", category=DeprecationWarning, stacklevel=2)
...
class Logger(object):
    ...
    def __init__(self):
        warnings.warn("Logger class has been deprecated, use the standard logging module", category=DeprecationWarning, stacklevel=2)
...
class LoggerModule(object):
    def __init__(self, manager, module):
        warnings.warn("LoggerModule class has been deprecated, use the standard logging module", category=DeprecationWarning, stacklevel=2)
